	...
	<div class="cjfit-summary">
		...
		foreach ($activity->steps as $i => $step)
		{
			...
			<div class="steps-page steps-page-<?php echo $i;?> new"<?php echo $i > 0 ? ' style="display: none;"' : '';?>>
				<div class="text-muted activity-date"><?php echo CjFitHelper::getActivityDate($step->activity_date);?></div>
				...
				<div class="text-center steps-guage-footer margin-bottom-20">
					<div class="footer-heading text-muted"><?php echo JText::sprintf('COM_CJFIT_GOAL_PERCENTAGE', $percent, $item->goals['steps'])?></div>
					<div class="text-muted"><?php echo JText::_('COM_CJFIT_LABEL_YOUR_DAILY_GOAL');?></div>
				</div>
			
				<div class="row summary-stats">
					<div class="col-md-4">
						<div class="text-center text-muted stats-num"><?php echo isset($activity->calories[$i]) ? $activity->calories[$i]->activity_value: 0;?></div>
						<div class="text-center text-muted stat-label"><?php echo JText::_('COM_CJFIT_LABEL_CALORIES');?></div>
					</div>
					<div class="col-md-4">
						<div class="text-center text-muted stats-num"><?php echo $distance . ' ' . $unit;?></div>
						<div class="text-center text-muted stat-label"><?php echo JText::_('COM_CJFIT_LABEL_DISTANCE');?></div>
					</div>
					<div class="col-md-4">
					<div class="text-center text-muted stats-num"><?php echo $item->average_daily_steps;?></div>
						<div class="text-center text-muted stat-label"><?php echo JText::_('COM_CJFIT_LABEL_DAILY_AVERAGE');?></div>
					</div>
				</div>
