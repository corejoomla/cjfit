...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cjfit&view=users');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped">
		<thead>
			<tr>
				...
				<th class="nowrap center">
					<?php echo JHtml::_('searchtools.sort', 'COM_CJFIT_FITBIT_CONNECTED', 'cju.fitbit_owner_id', $listDirn, $listOrder); ?>
				</th>
				<th class="nowrap center">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canChange = $loggeduser->authorise('core.edit.state',	'com_cjfit');
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if(!empty($item->fitbit_owner_id)):?>
					<img alt="fitbit" title="<?php echo JText::_('COM_CJFIT_FITBIT_CONNECTED');?>" class="hasTooltip"
						src="<?php echo JUri::root(true).'/media/com_cjfit/images/fitbit_logo_RGB.png';?>" style="max-height: 16px;">
					<?php endif;?>
				</td>
				<td class="center">
					<?php if ($canChange) : ?>
