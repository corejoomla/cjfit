...
class CjFitViewEmails extends JViewLegacy
{
	protected $items;
	...
	{
		$canDo = JHelperContent::getActions('com_cjfit', 'category', $this->state->get('filter.category_id'));
		$user  = JFactory::getUser();

		// Get the toolbar object instance
		$bar = JToolBar::getInstance('toolbar');

		JToolbarHelper::title(JText::_('COM_CJFIT_EMAIL_TEMPLATES_TITLE'), 'stack email');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			JToolbarHelper::checkin('emails.checkin');
		}
