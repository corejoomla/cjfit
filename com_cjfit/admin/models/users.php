...
class CjFitModelUsers extends JModelList
{
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'fitbit_owner_id', 'cju.fitbit_owner_id',
				'active',
				'group_id',
				'range',
				'state',
	...
	protected function getListQuery()
	{
		...
		// join over #__cjfit_users table
		$query
			->select('cju.handle, cju.fitbit_owner_id, cju.token, cju.height, cju.weight, cju.average_daily_steps, cju.stride_length_running')
			->select('cju.stride_length_walking, cju.attribs, cju.goals_date, cju.daily_goals, cju.last_fetched, cju.lifetime_stats')
			->join('LEFT', '#__cjfit_users AS cju on cju.id = a.id');
