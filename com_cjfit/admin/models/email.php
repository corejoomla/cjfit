...
class CjFitModelEmail extends JModelAdmin
{
	protected $text_prefix = 'COM_CJFIT';
	public $typeAlias = 'com_cjfit.email';
	 ...
	 */
	public function getTable($type = 'EmailTemplates', $prefix = 'CjFitTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_cjfit.email', 'email', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_cjfit.edit.email.data', array());
		...
		$this->preprocessData('com_cjfit.email', $data);
